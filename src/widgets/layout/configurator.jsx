...
export function Configurator() {
  ...
  // React.useEffect(() => {
  //   const stars = fetch(
  //     "https://api.github.com/repos/creativetimofficial/Dashboard_TI"
  //   )
      ...
      <div className="py-4 px-6">
        ...
        <div className="mb-12">
          ...
          <div className="my-8 flex flex-col gap-4">
            <a
              href="https://www.creative-tim.com/product/Dashboard_TI?rel=mtdr"
              target="_black"
            >
          ...
          <a
            ...
            href="https://github.com/creativetimofficial/Dashboard_TI"
            target="_blank"
            rel="noreferrer"
          >
            <Chip
